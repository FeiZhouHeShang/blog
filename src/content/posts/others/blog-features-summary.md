...
> [!info] 概述
> 本文档全面总结了本博客的功能特性、技术架构、配置选项和二次开发方法。无论你是想了解博客的完整能力，还是准备进行个性化定制，都能在这里找到答案。
>
...
**4. 置顶收敛**
- 仅本文（`blog-features-summary.md`）保持 `pinned: true`，其余文章均已移除
